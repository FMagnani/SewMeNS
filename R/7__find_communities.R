...
RA_g <- graph_from_adjacency_matrix(adjacencies$RA, mode = "undirected", weighted = TRUE, diag = FALSE, add.colnames = NA, add.rownames = NULL)
RD_g <- graph_from_adjacency_matrix(adjacencies$RD, mode = "undirected", weighted = TRUE, diag = FALSE, add.colnames = NA, add.rownames = NULL)
RL_g <- graph_from_adjacency_matrix(adjacencies$RL, mode = "undirected", weighted = TRUE, diag = FALSE, add.colnames = NA, add.rownames = NULL)

# routine="r-s-e-ll!rfr-trfr 5"
RA_comm <- custom_cluster_signed(RA_g, Resistance=resistance)
RD_comm <- custom_cluster_signed(RD_g, Resistance=resistance)
RL_comm <- custom_cluster_signed(RL_g, Resistance=resistance)
...
write_rds(communities, file="..\\data\\processed\\communities.rds")
